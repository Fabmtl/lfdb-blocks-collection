...
/* harmony import */ var _editor_scss__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./editor.scss */ "./src/lfdb-search/editor.scss");





const loupe = (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("svg", {
  xmlns: "http://www.w3.org/2000/svg",
  viewBox: "0 0 13.49 13.49",
  className: "icon"
}, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("path", {
  d: "M9.641 8.484h-.609l-.216-.208a5.021 5.021 0 1 0-.54.54l.208.216v.609l3.856 3.849 1.149-1.149zm-4.628 0a3.471 3.471 0 1 1 3.471-3.471 3.466 3.466 0 0 1-3.471 3.471z"
}));
function Edit(props) {
  const {
    attributes,
  ...
  return (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(react__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_2__.InspectorControls, null, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_2__.PanelColorSettings, {
    title: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)("Couleur de l'icône"),
    colorSettings: [{
      value: iconColor,
      ...
      label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)("Couleur de fond")
    }, {
      value: couleurTexte,
      onChange: onChangeCouleurTexte,
      label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)("Couleur de texte")
    }]
    ...
    title: "\xC9paisseur de la bordure",
    initialOpen: true
  }, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_3__.PanelRow, null, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_3__.__experimentalNumberControl, {
    label: "Bordure",
    isShiftStepEnabled: true,
  ...
  }, "Chercher"), (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("input", {
    type: "text",
    id: "s",
    name: "s",
...
/* harmony import */ var _style_scss__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./style.scss */ "./src/lfdb-search/style.scss");
/* harmony import */ var _edit__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./edit */ "./src/lfdb-search/edit.js");
/* harmony import */ var _save__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./save */ "./src/lfdb-search/save.js");
/* harmony import */ var _common_icons__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../../common/icons */ "./common/icons.js");
/* harmony import */ var _block_json__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./block.json */ "./src/lfdb-search/block.json");
...
const addToNavigation = (blockSettings, blockName) => {
  if (blockName === 'core/navigation') {
    ...
    return {
      ...blockSettings,
      allowedBlocks: [...((_blockSettings$allowe = blockSettings.allowedBlocks) !== null && _blockSettings$allowe !== void 0 ? _blockSettings$allowe : []), 'lfdb/search-block']
    };
  }
  return blockSettings;
};
(0,_wordpress_hooks__WEBPACK_IMPORTED_MODULE_1__.addFilter)('blocks.registerBlockType', 'lfdb-search-block-mega-menu-add-to-navigation', addToNavigation);

/***/ }),

/***/ "./src/lfdb-search/save.js":
/*!*********************************!*\
  !*** ./src/lfdb-search/save.js ***!
  \*********************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/***/ "./src/lfdb-search/block.json":
/*!************************************!*\
  !*** ./src/lfdb-search/block.json ***!
  \************************************/
/***/ ((module) => {

module.exports = /*#__PURE__*/JSON.parse('{"$schema":"https://schemas.wp.org/trunk/block.json","apiVersion":3,"name":"lfdb/search-block","version":"0.1.0","title":"Recherche lfdb","category":"lfdb-blocks","description":"Bloc recherche de la Fabrique de blogs","parent":["core/navigation"],"example":{},"supports":{"html":false,"anchor":true},"attributes":{"borderRadius":{"type":"string","default":"0px"},"searchPadding":{"type":"string","default":"0px"},"borderSize":{"type":"string","default":"1px"},"iconeSize":{"type":"string","default":"20px"},"iconColor":{"type":"string","default":"#333333"},"timeInterval":{"type":"number","default":4000},"couleurFond":{"type":"string","default":"transparent"},"couleurTexte":{"type":"string","default":"#333333"},"searchPlaceholderText":{"type":"string","default":"Rechercher..."}},"textdomain":"lfdb","editorScript":"file:./index.js","editorStyle":"file:./index.css","style":"file:./style-index.css","viewScript":"file:./view.js"}');
...
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, ["lfdb-search/style-index"], () => (__webpack_require__("./src/lfdb-search/index.js")))
