...
/***/ "./src/slider-swiper/components/inspector.js":
/*!***************************************************!*\
  !*** ./src/slider-swiper/components/inspector.js ***!
  \***************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
const Slidersettings = props => {
  ...
  const [navigation, setNavigation] = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_4__.useState)(hasNavigation);
  const [autoplay, setAutoplay] = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_4__.useState)(isAutoplay);
  const [isColumnView, setIsColumnView] = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_4__.useState)(columnView);
...
/* harmony import */ var _components_inspector__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./components/inspector */ "./src/slider-swiper/components/inspector.js");
/* harmony import */ var _editor_scss__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./editor.scss */ "./src/slider-swiper/editor.scss");
...
const TEMPLATE = [['lfdb/slide-swiper', {}]];
...
function Edit(props) {
  ...
  return (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_element__WEBPACK_IMPORTED_MODULE_5__.Fragment, null, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_components_inspector__WEBPACK_IMPORTED_MODULE_6__["default"], {
    ...props,
    swiperRef: swiperRef
...
/* harmony import */ var _style_scss__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./style.scss */ "./src/slider-swiper/style.scss");
/* harmony import */ var _edit__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./edit */ "./src/slider-swiper/edit.js");
/* harmony import */ var _save__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./save */ "./src/slider-swiper/save.js");
/* harmony import */ var _block_json__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./block.json */ "./src/slider-swiper/block.json");
...
(0,_wordpress_blocks__WEBPACK_IMPORTED_MODULE_0__.registerBlockType)(_block_json__WEBPACK_IMPORTED_MODULE_4__.name, {
   ...
   * @see ./edit.js
   */
  icon: _common_icons__WEBPACK_IMPORTED_MODULE_5__["default"].slider,
...
/***/ "./src/slider-swiper/block.json":
/*!**************************************!*\
  !*** ./src/slider-swiper/block.json ***!
  \**************************************/
/***/ ((module) => {

module.exports = /*#__PURE__*/JSON.parse('{"$schema":"https://schemas.wp.org/trunk/block.json","apiVersion":2,"name":"lfdb/slider-swiper","version":"0.1.0","title":"Slider Full Screen","category":"lfdb-blocks","description":"Slider plein écran, utilise le bloc \'lfdb/slide\'","supports":{"html":true,"align":["full","wide"],"alignWide":true,"ariaLabel":true,"multiple":false},"attributes":{"align":{"type":"string","default":"full"},"columnView":{"type":"boolean","default":false},"hasNavigation":{"type":"boolean","default":true},"isAutoplay":{"type":"boolean","default":false},"autoPlayDuration":{"type":"string","default":"4000"}},"textdomain":"lfdb","viewScript":"file:./view.js","editorScript":["file:./index.js","https://cdn.jsdelivr.net/npm/swiper@11/swiper-element-bundle.min.js"],"editorStyle":"file:./index.css","style":"file:./style-index.css"}');
...
/******/ 		var installedChunks = {
/******/ 			"slider-swiper/index": 0,
/******/ 			"slider-swiper/style-index": 0
/******/ 		};
/******/ 		
...
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, ["slider-swiper/style-index"], () => (__webpack_require__("./src/slider-swiper/index.js")))
